...
namespace Zhihe.Smartplatform.SysTools
{
    public static class DB_SqlHelper
    {
        ...
        /// <summary>
        /// 通过sql语句来获取一个DataTable类型的数据.如果type参数值是null时，默认取CommandType.Text
        /// </summary>
        /// <param name="sql"></param>
        /// <param name="type">如果type参数值是null时，默认取CommandType.Text</param>
        ...
        public static DataTable GetTable(string sql, CommandType type,params SqlParameter[] pars)
        {
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                {
                    adapter.SelectCommand.CommandType = type==null?CommandType.Text:type;
                    if(pars != null)
                    {
        ...
        //{
        //    if (connStr == null || connStr.Length == 0) throw new ArgumentNullException("connectionString");
        //    if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        //    // 如果存在参数值
        //    if ((parameterValues != null) && (parameterValues.Length > 0))
        //    {
        //        // 从探索存储过程参数(加载到缓存)并分配给存储过程参数数组.
        //        SqlParameter[] commandParameters = SqlHelperParameterCache.GetSpParameterSet(connStr, spName);
        //        // 给存储过程参数赋值
        ...
        //    {
        //        // 没有参数情况下
        //        return ExecuteNonQuery(connStr, CommandType.StoredProcedure, spName);
        //    }
        //}
       ...
       // private SqlHelper() {}
        ...
        public static int ExecuteNonQueryTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return DB_SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static DataSet ExecuteDatasetTypedParams(string connectionString, String spName, DataRow dataRow)
        {
            ...
            if ( dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if( dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if( dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static SqlDataReader ExecuteReaderTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if ( dataRow != null && dataRow.ItemArray.Length > 0 )
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if( dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if( dataRow != null && dataRow.ItemArray.Length > 0 )
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static object ExecuteScalarTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if( dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if( dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if( dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if( dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if( dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return DB_SqlHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return DB_SqlHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
    }
